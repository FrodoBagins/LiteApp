...
public class TodoDbAdapter {
    ...
    public static final String KEY_DESCRIPTION = "completed";
    ...
    public boolean updateTodo(TodoTask task) {
        ...
        return updateTodo(id, name, description);
    }

    public boolean updateTodo(long id, String name, String description) {
    ...
    public TodoTask getTodo(long id) {
        ...
        if(cursor != null && cursor.moveToFirst()) {
            ...
            task = new TodoTask(id, name, description);
        }
        return task;
    }
}